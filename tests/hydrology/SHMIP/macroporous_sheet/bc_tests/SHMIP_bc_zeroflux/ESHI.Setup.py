...
#    print('Config file for this experiment:', newConfigFile)
    ...
    if expt == 'SteadyStateA':
        ...
        m           = 7.93e-11*sec2yr # water input, m y-1
        ...
        inputslice  = 1
        outputfreq  = args.outputfreq
        m           = 1.59e-9*sec2yr # water input, m y-1
        ...
        inputslice  = 1
        outputfreq  = args.outputfreq
        m           = 5.79e-9*sec2yr # water input, m y-1
        ...
        inputslice  = 1
        outputfreq  = args.outputfreq
        m           = 2.5e-8*sec2yr # water input, m y-1
        ...
        inputslice  = 1
        outputfreq  = args.outputfreq
        m           = 4.5e-9*sec2yr # water input, m y-1
        ...
        inputslice  = 1
        outputfreq  = args.outputfreq
        m           = 5.79e-7*sec2yr # water input, m y-1
