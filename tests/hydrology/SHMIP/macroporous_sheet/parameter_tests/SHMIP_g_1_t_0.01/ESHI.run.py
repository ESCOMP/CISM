...
# This script runs any or all of the various SHMIP Suite A experiments.
...
for expt in experiments:
    ...
    if options.parallel == None:
        ...
        os.system(f"{options.executable} {configfile} > {terminal_log} 2>&1")
        # os.system(f"{options.executable} {configfile}")
    else:
