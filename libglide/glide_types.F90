...
!!  integer, parameter :: BAS_PROC_FASTCALC = 2
  ...
  type glide_geometry
    ...
    real(dp),dimension(:,:),  pointer :: forceretreat_flux =>null()      !> Michele
    real(dp),dimension(:,:),  pointer :: forceretreat_flux_tavg =>null() !> Michele, residual calc
    real(dp),dimension(:,:),  pointer :: rmicecap_flux =>null()      !> Michele
    real(dp),dimension(:,:),  pointer :: rmicecap_flux_tavg =>null() !> Michele, residual calc
    ...
    real(dp) :: total_forceretreat_flux  ! Michele
    real(dp) :: total_rmicecap_flux  ! Michele
    ...
    real(dp) :: total_forceretreat_flux_tavg !Michele
    real(dp) :: total_rmicecap_flux_tavg !Michele
...
!       Here, acab has units of m/y ice, whereas in Glint, acab has units of m/y water equiv.
  ...
  type glide_calving
     ...
     real(dp),dimension(:,:),  pointer :: forceretreat_thck => null() !>Michele
     real(dp),dimension(:,:),  pointer :: rmicecap_thck => null() !>Michele
