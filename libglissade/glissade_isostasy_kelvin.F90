!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!                                                             
!   glissade_isostasy_kelvin.F90 - part of the Community Ice Sheet Model (CISM)  
!                                                              
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
!
...
!! \date June 2000
!! Added to the Glissade dycore by William Lipscomb, July 2026

module glissade_isostasy_kelvin
  ...
  private
  public :: set_kelvin, ber, bei, ker, kei, dber, dbei, dker, dkei 

  real(kind=dp), parameter :: gamma=0.577215664901532860606512d0 !< Euler's constant
  integer :: j_max = 40 !< maximum number of iterations
  real(kind=dp) :: tolerance = 1.d-10 !< the tolerance
...
end module glissade_isostasy_kelvin
